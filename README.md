...
### realizar test de sonarqube
C:\Users\Bus209\Documents\htdocs\eShopOnWeb

dotnet <Ruta Completa de SonarScanner.MSBuild.dll> begin /k:"project-key"
dotnet build
dotnet <Ruta Completa de SonarScanner.MSBuild.dll> end

dotnet C:\sonarqube-8.9.10.61524\sonar-s-netcore2.0\SonarScanner.MSBuild.dll begin /k:"eShopOnWebID"
dotnet build
dotnet C:\sonarqube-8.9.10.61524\sonar-s-netcore2.0\SonarScanner.MSBuild.dll end
